...
public class BaseTest {
	...
	public WebDriver driver; //reference of WebDriver
	
	// object created because ConfigDataProvider class does not have static method
 ...
 public void captureScreenShot(WebDriver driver,String testName) throws IOException 
 {
	 ...
	 File srcpath=new File("."+"//Screenshots//"+ testName + ".png"); //srcpath is destination
